    ...
    def scatter(
        ...
        **style_kwds,
        ...
        if vdf.shape()[0]<max_nb_points:
            ...
            data_frame=vdf.sample(n=max_nb_points,method='random'.to_pandas())
        kwargs = {'data_frame': data_frame, 'x': columns[0], 'y': columns[1]}
        if catcol:
            kwargs['color']=catcol
        fig=px.scatter(**kwargs,**style_kwds)
    ...
    def scatter_3d(
        ...
        **style_kwds,
        ...
        if vdf.shape()[0]<max_nb_points:
            ...
            data_frame=vdf.sample(n=max_nb_points,method='random'.to_pandas())
        kwargs = {'data_frame': data_frame, 'x': columns[0], 'y': columns[1],'z':columns[2]}
        if catcol:
            kwargs['color']=catcol
